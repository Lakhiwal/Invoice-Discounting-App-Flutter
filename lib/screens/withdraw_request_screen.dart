...
class _WithdrawRequestScreenState extends State<WithdrawRequestScreen> {
        ...
        slivers: [
          SliverAppBar(
            ...
            actions: const [
              SizedBox(
                  width:
                      56), // Placeholder to maintain center balance if needed
            ],
          ),
          SliverToBoxAdapter(
            child: Padding(
  ...
  Widget _buildAmountField(ColorScheme cs, TextTheme tt) => TextFormField(
  ...
  Widget _buildSubmitButton(ColorScheme cs) => SizedBox(
