...
// Item #8: VibrationHelper replaced by AppHaptics (already imported)
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Column(children: [
            ...
            _DetailRow(
                label: 'Age', value: '${nominee.age} years'),
...
// ─────────────────────────────────────────────────────────────────────────────
// Form
// FIX: guardian field now appears reactively as user types age < 18
// ─────────────────────────────────────────────────────────────────────────────
  ...
  Future<void> _save() async {
    ...
    if (age < 18 && _guardianCtrl.text.trim().isEmpty) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
            content:
            Text('Guardian name is required for minor nominees')),
      );
    ...
    try {
      ...
      if (!result['success']) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content:
              Text(result['error'] ?? 'Failed to save nominee')),
        );
        return;
      }
      ...
      child: Form(
        ...
        child: Column(
          ...
          children: [
            ...
            // FIX: guardian field appears reactively when age < 18 is typed
            AnimatedSize(
            ...
            _input('Address', _addressCtrl, maxLines: 3),
